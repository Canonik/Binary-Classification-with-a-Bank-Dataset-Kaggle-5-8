...
def Total_dataset_training():
    ...
    joblib.dump(sanity_check_rnd_forest_model, "models/sanity_check_rnd_forest_model_full_dataset_pipeline1.pkl")
    ...
    predictions_df.to_csv("reports/sanity_check_full_dataset_predictions_pipeline1.csv")
